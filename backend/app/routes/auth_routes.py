...
# Admin Routes
auth_bp.route('/admin/register', methods=['POST'])(auth_controller.create_admin)
auth_bp.route('/admin/login', methods=['POST'])(auth_controller.login_admin)
auth_bp.route('/admin/reset-password', methods=['POST'])(auth_controller.reset_admin_password)
auth_bp.route('/admin/update-password', methods=['POST'])(auth_controller.update_admin_password)
